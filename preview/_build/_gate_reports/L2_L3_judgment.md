# L2 (per-part judgment) + L3 (corpus) gate

Model: general-purpose subagent, adversarial. Read all five finished articles.

## Result: PASS (overall)

### L2 per part
| Part | risk survived | padding verdict | claim density | reject tests | verdict |
|---|---|---|---|---|---|
| 1 | PASS (continuum stated; criteria = clinician judgment, not self-test) | pass (~70 removable, scattered) | 13 | 5/5 | PASS |
| 2 | PASS (positive symptoms = weakest predictor, unhedged + cited) | pass (~60) | 11 | 5/5 | PASS |
| 3 | PASS (all 4 risk clauses survive: dopamine partial, D2 limit, glutamate co-equal, no biomarker) | pass (~70) | 13 | 5/5 | PASS |
| 4 | PASS (family RR 0.55 rivals meds; non-adherence rational) | pass (~95, tightened) | 15 | 5/5 | PASS |
