-- =============================================================================
-- Add verification_status filter to search_providers_v2
-- Changes:
--   1. New parameter: p_verification_status text ('verified' | 'listed' | NULL)
--   2. 'verified' = verified_at IS NOT NULL OR status IN ('verified', 'active')
--   3. 'listed'   = status = 'seeded' AND verified_at IS NULL
--   4. NULL/empty = no filter (existing behavior)
-- =============================================================================
