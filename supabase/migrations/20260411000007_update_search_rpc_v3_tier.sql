-- =============================================================================
-- Update search_providers_v2 for 3-tier system + trust_score_cached output
-- Changes:
--   1. Add trust_score_cached to RETURNS TABLE
--   2. Update tier sort: elite(0) > pro(1) > free(2)
--   3. Secondary sort by trust_score_cached DESC
-- =============================================================================
