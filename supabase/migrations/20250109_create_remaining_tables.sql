-- =====================================================
-- Migration: Create remaining application tables
-- Date: 2025-01-09
-- Description: Assessment, symptoms, mood, sleep, activity, and analytics tables
-- =====================================================
...
CREATE POLICY "Assessment questions are publicly readable"
    ON public.assessment_questions FOR SELECT TO public
...
CREATE POLICY "Symptoms are publicly readable"
    ON public.symptoms FOR SELECT TO public USING (true);
...
CREATE POLICY "Conditions are publicly readable"
    ON public.conditions FOR SELECT TO public USING (true);
...
CREATE POLICY "Condition symptoms are publicly readable"
    ON public.condition_symptoms FOR SELECT TO public USING (true);

-- Map symptoms to conditions
INSERT INTO public.condition_symptoms (condition_id, symptom_id, weight) VALUES
('anxiety', 'anxiety-general', 1.0),
('anxiety', 'anxiety-panic', 0.9),
('anxiety', 'anxiety-social', 0.8),
('depression', 'mood-sad', 1.0),
('depression', 'mood-hopeless', 0.95),
('depression', 'sleep-insomnia', 0.7),
('depression', 'sleep-oversleep', 0.7),
('stress', 'stress-overwhelmed', 1.0),
('stress', 'stress-burnout', 0.9),
('stress', 'mood-irritable', 0.7),
...
CREATE POLICY "Crisis resources are publicly readable"
    ON public.crisis_resources FOR SELECT TO public USING (is_active = true);

-- Insert US crisis resources
...
CREATE POLICY "Providers can view their own analytics"
    ON public.provider_analytics FOR SELECT TO authenticated
...
-- Function to increment provider profile views
