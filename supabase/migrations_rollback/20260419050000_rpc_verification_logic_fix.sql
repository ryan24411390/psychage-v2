-- =============================================================================
-- Rollback for Phase 0.6 RPC verification logic fix.
-- Apply manually only: psql $DATABASE_URL -f supabase/migrations_rollback/20260419000001_rpc_verification_logic_fix.sql
-- This file is NOT auto-applied by `npx supabase db push`.
--
-- Restores the previous function body with OR logic. Use only if the corrected
-- RPC causes unexpected production issues.
-- =============================================================================
...
COMMENT ON FUNCTION public.search_providers_v2 IS
  'ROLLBACK: restored pre-Phase-0.6 verification logic (OR-based). Breaks UI consistency
   with Phase 2b badges. Use only for emergency recovery.';
