...
const ArticleSection: React.FC<ArticleSectionProps> = ({ onViewArticle }) => {
      ...
      <div className="container mx-auto max-w-[1280px]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center">
                ...
                <a href="#" className="inline-flex items-center gap-2 text-lg font-bold text-gray-900 dark:text-white mt-12 hover:text-teal-600 dark:hover:text-teal-400 transition-colors group">
