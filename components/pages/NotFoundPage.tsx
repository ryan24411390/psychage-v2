...
const NotFoundPage: React.FC<NotFoundPageProps> = ({ onGoHome, onSearch }) => {
  return (
      ...
      <div className="max-w-md w-full text-center">
         ...
         <div className="mt-12 pt-8 border-t border-gray-200">
             ...
             <div className="flex flex-col gap-2">
                 <button onClick={onGoHome} className="text-sm font-medium text-gray-600 hover:text-teal-600 flex items-center justify-center gap-1 group transition-colors">
