...
const ClarityScoreTool: React.FC<ClarityScoreToolProps> = () => {
        ...
        return (
            <div className="min-h-screen bg-white pt-24 pb-12 px-6 flex items-center justify-center">
                <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <button onClick={() => navigate('/')} className="flex items-center gap-2 text-gray-400 hover:text-gray-900 mb-8 font-bold text-sm uppercase tracking-wider">
        ...
        <div className="min-h-screen bg-white pt-24 pb-12 px-6">
            <div className="container mx-auto max-w-4xl">
                ...
                <div className="mt-16 text-center">
                    ...
                    <Button onClick={() => navigate('/')} variant="ghost" className="ml-4">
                        Back to Home
                    </Button>
                </div>
            </div>
