...
const ProviderProfile: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-[#fafaf9] pt-28 pb-20">
            <SEO
                title={`${provider.name} | Psychage`}
                description={`${provider.role} specializing in ${provider.specialties.join(', ')}.`}
                image={provider.image}
                type="profile"
            />
            <div className="container mx-auto max-w-5xl px-6">

                <button onClick={() => navigate('/providers')} className="flex items-center gap-2 text-gray-500 hover:text-gray-900 mb-8 font-bold text-sm uppercase tracking-wider transition-colors">
