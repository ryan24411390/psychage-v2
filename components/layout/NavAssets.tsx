...
export const NavClarityGlyph = () => (
  <svg viewBox="0 0 40 40" className="w-full h-full text-teal-600" fill="none">
...
export const NavMoodGlyph = () => (
  <svg viewBox="0 0 40 40" className="w-full h-full text-amber-600" fill="none">
...
export const NavSleepGlyph = () => (
  <svg viewBox="0 0 40 40" className="w-full h-full text-indigo-600" fill="none">
...
export const NavArticleGlyph = () => (
  <svg viewBox="0 0 40 40" className="w-full h-full text-gray-900" fill="none">
...
export const NavCrisisGlyph = () => (
  <svg viewBox="0 0 40 40" className="w-full h-full text-red-600" fill="none">
