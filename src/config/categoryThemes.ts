...
/**
 * 15 category themes aligned with `article_categories` table slugs.
 * Each entry's slug key matches the DB `slug` column exactly.
 */
export const categoryThemes: CategoryThemeMap = {
    ...
    'relationships-social': {
        label: 'Relationships & Social Health',
        colorFamily: 'pink',
        icon: Users,
