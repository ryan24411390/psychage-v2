      ...
      <AnimatePresence>
        {!isAtBottom && (
          <motion.button
            ...
            className="absolute bottom-4 left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-white dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 shadow-lg flex items-center justify-center text-slate-500 dark:text-neutral-400 hover:text-slate-700 dark:hover:text-neutral-300 dark:hover:text-neutral-300 transition-colors"
