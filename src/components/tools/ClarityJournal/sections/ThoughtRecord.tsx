  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 pt-24 pb-12 px-6">
      ...
      <div className="container mx-auto max-w-2xl">
        ...
        <h1 className="font-display font-bold text-2xl md:text-3xl text-slate-900 dark:text-neutral-100 mb-2">Thought Record</h1>
        <p className="text-slate-500 dark:text-neutral-400 mb-8">See your thoughts clearly, instead of being swept away by them.</p>

        {/* Explanation card */}
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="bg-white dark:bg-neutral-900 rounded-2xl p-6 md:p-8 shadow-sm border border-slate-100 dark:border-neutral-800 mb-6"
        >
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 rounded-xl bg-amber-100 text-amber-600 flex items-center justify-center">
              <Lightbulb className="w-5 h-5" />
            </div>
            <h2 className="font-display font-semibold text-slate-900 dark:text-neutral-100">Cognitive Restructuring</h2>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-neutral-900 rounded-xl">
              ...
              <div>
                <p className="text-sm font-medium text-slate-700 dark:text-neutral-300">Identify the situation</p>
                <p className="text-xs text-slate-500 dark:text-neutral-400">What happened? Where were you? Who was involved?</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-neutral-900 rounded-xl">
              ...
              <div>
                <p className="text-sm font-medium text-slate-700 dark:text-neutral-300">Notice your automatic thoughts</p>
                <p className="text-xs text-slate-500 dark:text-neutral-400">What went through your mind? What were you telling yourself?</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-neutral-900 rounded-xl">
              ...
              <div>
                <p className="text-sm font-medium text-slate-700 dark:text-neutral-300">Examine the evidence</p>
                <p className="text-xs text-slate-500 dark:text-neutral-400">What supports this thought? What contradicts it?</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-slate-50 dark:bg-neutral-900 rounded-xl">
              ...
              <div>
                <p className="text-sm font-medium text-slate-700 dark:text-neutral-300">Find a balanced perspective</p>
                <p className="text-xs text-slate-500 dark:text-neutral-400">What would you tell a friend? What's a more realistic view?</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="bg-white dark:bg-neutral-900 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-neutral-800"
        >
          <div className="flex items-center gap-3 mb-3">
            <BookOpen className="w-5 h-5 text-teal-600" />
            <h3 className="font-display font-semibold text-slate-800 dark:text-neutral-200">Practice in Your Journal</h3>
          </div>
