        ...
        {expanded && (
          ...
          >
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 space-y-3 mt-1">
              {/* Age Group */}
              <div>
                <label htmlFor="age-group" className="text-xs font-medium text-gray-500 block mb-1">
                  Age Group
                </label>
                <select
                  id="age-group"
                  ...
                  className="w-full p-2 rounded-lg border border-gray-200 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none bg-white"
                >
                  {AGE_OPTIONS.map(o => (
              ...
              {/* Chronotype */}
              <div>
                <label htmlFor="chronotype" className="text-xs font-medium text-gray-500 block mb-1">
                  Chronotype
                </label>
                <select
                  id="chronotype"
              ...
              {/* Target Sleep */}
              <div>
                <label htmlFor="target-sleep" className="text-xs font-medium text-gray-500 block mb-1">
                ...
                <input
                  ...
                  className="w-full p-2 rounded-lg border border-gray-200 text-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 outline-none"
                />
              </div>

              {/* Caffeine Cutoff */}
              <div>
                <label htmlFor="caffeine-cutoff" className="text-xs font-medium text-gray-500 block mb-1">
              ...
              {/* Exercise Time */}
              <div>
                <label htmlFor="exercise-time" className="text-xs font-medium text-gray-500 block mb-1">
