...
const categories = [
    { slug: 'self-worth-identity', label: 'Self-Worth' },
    { slug: 'relationships-communication', label: 'Relationships' },
];

const LifestylePreview: React.FC = () => {
                ...
                >
                    <div>
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400 max-w-lg">
                            Build self-worth, navigate relationships, and develop the confidence to show up authentically in every area of your life.
                        </p>
                    </div>
                    <Button
                        variant="outline"
                                ...
                                {articles.map((article) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <h3 className="font-display font-bold text-slate-900 dark:text-white leading-snug group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors line-clamp-2">
                                                {article.title}
                                            </h3>
                                        </div>
                                    );
