...
const VideoShowcaseSection: React.FC = () => {
    ...
    return (
        <section ref={scrollRef} className="py-24 bg-[#050505] text-white overflow-hidden relative">
            <div className="container mx-auto px-6 md:px-12 mb-12 relative z-10">
                <div className="flex flex-col md:flex-row justify-between items-end gap-6 border-b border-gray-800 pb-8">
                    <div>
                        ...
                        <Display className="text-3xl md:text-4xl font-bold mb-4 text-white">
                            Watch & Learn
                        </Display>
                        <Text className="text-gray-400 max-w-xl text-lg">
            ...
            <div className="relative w-full overflow-x-auto pb-12 hide-scrollbar pl-6 md:pl-12">
                <div className="flex gap-6 w-max">
                    {videos.map((video, index) => (
                        ...
                        >
                            <div className="aspect-video rounded-xl overflow-hidden relative mb-4 bg-gray-900">
                                <img
                                    src={video.thumbnail}
                                    alt={video.title}
                            ...
                            <div className="pr-4">
                                ...
                                <h3 className="text-lg font-bold text-white mb-2 group-hover:underline decoration-gray-600 underline-offset-4 transition-all line-clamp-2">
                                    {video.title}
                                </h3>
