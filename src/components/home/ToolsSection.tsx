...
const ToolsSection: React.FC = () => {
    ...
    return (
        <section className="py-24 px-6 bg-gray-50 dark:bg-[#0a0a0a] border-y border-gray-100 dark:border-gray-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {tools.map((tool, index) => (
                        <motion.div
                            ...
                            className="group cursor-pointer bg-white dark:bg-gray-900 p-8 rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-300 hover:shadow-lg"
                        >
                            <div className="w-12 h-12 rounded-xl bg-gray-50 dark:bg-gray-800 flex items-center justify-center mb-6 group-hover:bg-gray-100 dark:group-hover:bg-gray-700 transition-colors">
                                <tool.icon size={24} className="text-gray-900 dark:text-white" />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:underline decoration-gray-300 underline-offset-4 transition-all">
                                {tool.name}
                            </h3>
