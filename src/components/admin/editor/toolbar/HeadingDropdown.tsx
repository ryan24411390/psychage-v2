...
const HEADINGS = [
  ...
  { level: 4, label: 'Subtitle', shortcut: 'H4', className: 'text-sm font-medium text-gray-600 dark:text-slate-400' },
] as const;
  ...
  return (
    <DropdownMenu.Root>
      <DropdownMenu.Trigger asChild>
        <button
          type="button"
          className="flex items-center gap-1 px-2 py-1 rounded text-xs font-medium text-gray-600 dark:text-slate-400 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors min-w-[60px]"
        >
          {label}
          <ChevronDown size={12} />
        </button>
      ...
      <DropdownMenu.Portal>
        ...
        >
          <DropdownMenu.Item
            ...
            className="flex items-center justify-between px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-100 dark:hover:bg-slate-700 cursor-pointer outline-none"
          >
            <span>Normal text</span>
            {!activeHeading && <span className="text-teal-500 text-xs">Active</span>}
          </DropdownMenu.Item>
          ...
          {HEADINGS.map((h) => (
            <DropdownMenu.Item
              ...
              className="flex items-center justify-between px-3 py-2 hover:bg-gray-100 dark:hover:bg-slate-700 cursor-pointer outline-none"
            >
