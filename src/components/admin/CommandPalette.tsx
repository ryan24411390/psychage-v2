  ...
  const commands: CommandItem[] = useMemo(
    () => [
      // Navigation
      {
        ...
        action: () => navigate(adminPath('/dashboard')),
      ...
      },
      {
        ...
        label: 'Go to Content',
        icon: FileText,
        action: () => navigate(adminPath('/content')),
        keywords: ['pages', 'documents', 'guides'],
        section: 'Navigation',
      },
      {
        id: 'nav-articles',
        ...
        icon: Newspaper,
        action: () => navigate(adminPath('/articles')),
        keywords: ['articles', 'review', 'ratings', 'publish'],
        section: 'Navigation',
      },
      {
        id: 'nav-clusters',
        label: 'Go to Topic Clusters',
        icon: Network,
        action: () => navigate(adminPath('/articles/clusters')),
        keywords: ['clusters', 'breakdown', 'topics', 'series'],
        section: 'Navigation',
      },
      {
        id: 'nav-article-categories',
        label: 'Go to Article Categories',
        icon: FolderTree,
        action: () => navigate(adminPath('/articles/categories')),
        keywords: ['categories', 'taxonomy', 'distribution'],
        section: 'Navigation',
      },
      {
        id: 'nav-pipeline',
        label: 'Go to Article Pipeline',
        icon: ListChecks,
        action: () => navigate(adminPath('/articles/pipeline')),
        keywords: ['pipeline', 'review stage', 'workflow', 'kanban'],
        section: 'Navigation',
      },
      {
        id: 'nav-tree',
        label: 'Go to Content Tree',
        icon: GitBranch,
        action: () => navigate(adminPath('/articles/tree')),
        keywords: ['tree', 'hierarchy', 'derivatives', 'parent'],
        section: 'Navigation',
      },
      {
        id: 'nav-quality-map',
        label: 'Go to Quality Map',
        icon: BarChart3,
        action: () => navigate(adminPath('/articles/quality')),
        keywords: ['quality', 'map', 'taxonomy', 'coverage'],
        section: 'Navigation',
      },
      {
        id: 'nav-quality-dashboard',
        label: 'Go to Quality Dashboard',
        icon: BarChart3,
        action: () => navigate(adminPath('/articles/quality-dashboard')),
        keywords: ['quality', 'dashboard', 'rewrite', 'audit'],
        section: 'Navigation',
      },
      {
        id: 'nav-citations',
        label: 'Go to Citation Report',
        icon: BookOpen,
        action: () => navigate(adminPath('/articles/citations')),
        keywords: ['citations', 'sources', 'references', 'evidence'],
        section: 'Navigation',
      },
      {
        id: 'nav-toolkits',
        label: 'Go to Toolkits',
        icon: Wrench,
        action: () => navigate(adminPath('/toolkits')),
        keywords: ['toolkits', 'exercises', 'resources'],
        section: 'Navigation',
      },
      {
        id: 'nav-providers',
        ...
        icon: Users,
        action: () => navigate(adminPath('/providers')),
      ...
      },
      {
        ...
        icon: Brain,
        action: () => navigate(adminPath('/symptom-navigator/symptoms')),
      ...
      },
      {
        ...
        label: 'Go to Safety',
        icon: Shield,
        action: () => navigate(adminPath('/safety')),
      ...
      },
      {
        ...
        icon: Settings,
        action: () => navigate(adminPath('/settings')),
      ...
      // Actions
      {
        ...
        icon: Plus,
        action: () => navigate(adminPath('/content/new')),
      ...
      },
      {
        ...
        icon: ClipboardList,
        action: () => navigate(adminPath('/providers/applications')),
      ...
      },
      {
        ...
        icon: MapPin,
        action: () => navigate(adminPath('/symptom-navigator/mappings')),
      ...
      },
      {
        ...
        icon: AlertTriangle,
        action: () => navigate(adminPath('/safety/keywords')),
      ...
      },
      {
        ...
        icon: History,
        action: () => navigate(adminPath('/settings/audit-log')),
      ...
      },
      {
        ...
        icon: Users,
        action: () => navigate(adminPath('/settings/users')),
      ...
      },
      {
        ...
        icon: Users,
        action: () => navigate(adminPath('/providers/import')),
