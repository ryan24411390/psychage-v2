...
function labelForResource(r: CrisisResource, t: TFunction): string {
  if (r.phone) return r.phone;
  if (r.text_instruction) return r.text_instruction;
  return r.web_url ? t('crisis.layoutResources.visit_website') : r.name;
}
