...
export const SymptomReviewPanel: React.FC<SymptomReviewPanelProps> = ({
    ...
    return (
        <div className={cn("bg-surface/50 border border-border rounded-xl backdrop-blur-xl shadow-lg overflow-hidden", className)}>
            {/* Header - Always visible */}
            <button
                type="button"
                onClick={() => setIsExpanded(!isExpanded)}
                className="w-full px-4 py-3 flex items-center justify-between hover:bg-surface-hover/50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                            ...
                            {symptoms.map((symptom, index) => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        "hover:bg-surface-hover/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-inset",
                                ...
                                >
                                    ...
                                    <span className={cn(
                                        ...
                                        symptom.isComplete ? "text-text-primary" : "text-text-secondary"
                                    )}>
                                        {symptom.name}
                                    </span>
                                    {currentIndex === index && (
