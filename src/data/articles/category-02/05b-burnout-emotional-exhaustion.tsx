...
export const burnoutEmotionalExhaustionArticlesB: Article[] = [
  ...
  // ============================================================================
  {
    ...
    summary: 'Burnout is primarily a systemic problem requiring organizational solutions, yet 85% of workplace interventions focus on individual coping rather than structural change. Effective prevention requires both: organizations must address workload, autonomy, fairness, and community while individuals develop boundaries, recovery practices, and values clarity to manage unavoidable stress.',
    keyFacts: [
      { text: '85% of workplace burnout interventions target individual employees rather than organizational structures, despite evidence that systemic factors are primary causes', citationIndex: 1 },
      { text: 'Job demands like workload and time pressure are stronger predictors of burnout than personal resilience factors', citationIndex: 2 },
      { text: 'Effective organizational prevention addresses six areas: workload, control, reward, community, fairness, and values alignment', citationIndex: 3 },
      { text: 'Individual strategies without organizational change can increase shame by implying the problem is inability to cope rather than unreasonable demands', citationIndex: 1 },
      { text: 'Most people find 60-80% of their burnout drivers are organizational rather than individual when auditing sources of stress', citationIndex: 4 },
    ],
    sparkMoment: 'You need both organizational change and individual strategies — without systemic change, individual coping is like bailing water from a sinking ship: exhausting and ultimately futile.',
    practicalExercise: {
      title: 'Burnout Source Audit',
      steps: [
        { title: 'List Your Top 5 Stressors', description: 'Write down the 5 things that drain you most at work. Be specific: "Unclear expectations from my manager," not just "my boss." What actually depletes you day to day?' },
        { title: 'Categorize Each Stressor', description: 'For each stressor, ask: "Could I personally change this with better coping skills, or would this require organizational/structural changes?" Categorize as Individual, Organizational, or Mixed (both needed).' },
        { title: 'Calculate the Breakdown', description: 'What percentage of your stressors are truly individual vs. organizational? Most people find 60-80% are organizational. This clarifies where effort should focus and releases shame about "not coping well enough."' },
        { title: 'Take Appropriate Action', description: 'For individual items: implement coping strategies. For organizational items: advocate for change or assess if this workplace is sustainable. For mixed items: do both. Focus 80% of energy on what you can control or influence; accept or exit what you cannot.' },
      ],
      toolLink: '/tools/mood-journal',
      toolLabel: 'Track Burnout Patterns',
    },
    citations: [
      {
        id: '1',
      ...
      },
      {
        ...
        source: 'Journal of Applied Psychology',
        year: '2017',
        link: 'https://doi.org/10.1037/apl0000141',
        tier: 1,
      },
      {
        id: '5',
        text: 'Workplace autonomy and burnout',
        source: 'Journal of Occupational Health Psychology',
        year: '2018',
        link: 'https://doi.org/10.1037/ocp0000102',
        tier: 1,
      },
      {
        id: '6',
        text: 'Workload management interventions',
        source: 'Occupational and Environmental Medicine',
        year: '2019',
        link: 'https://doi.org/10.1136/oemed-2018-105406',
        tier: 1,
      },
      {
        id: '7',
        text: 'Fairness and burnout in organizations',
        source: 'Organizational Behavior and Human Decision Processes',
        year: '2018',
        link: 'https://doi.org/10.1016/j.obhdp.2018.01.003',
        tier: 1,
      },
      {
        id: '8',
        text: 'Individual boundary-setting strategies',
        source: 'Work & Stress',
        year: '2020',
        link: 'https://doi.org/10.1080/02678373.2020.1738333',
        tier: 1,
      },
    ],
    content: (
  ...
  // ============================================================================
  {
    ...
    summary: 'Vacations provide temporary relief from burnout, but benefits typically fade within 2-4 weeks of returning to work if no other changes are made. Lasting recovery requires rest as a foundation combined with active interventions: workload reduction, skill development, values realignment, boundary-setting, and environmental changes that address root causes rather than just symptoms.',
    keyFacts: [
      { text: 'Vacation benefits typically fade within 2-4 weeks of returning to work, sometimes faster if returning to the same burnout-causing conditions', citationIndex: 1 },
      { text: 'Rest addresses the symptom of exhaustion but not root causes like unsustainable workloads, toxic culture, values misalignment, or lack of autonomy', citationIndex: 2 },
      { text: 'Active recovery practices like exercise, hobbies, and socializing are more effective than passive rest like TV or scrolling for sustained wellbeing', citationIndex: 3 },
      { text: 'The most effective recovery combines rest with environmental changes — one or more of: workload reduction, relationship repair, skill development, values realignment, or active recovery practices', citationIndex: 2 },
      { text: 'If rest provides zero relief even during time off, this may indicate clinical depression or anxiety alongside burnout requiring professional help', citationIndex: 4 },
    ],
    sparkMoment: 'Rest treats the symptom of exhaustion but not the cause — you cannot rest your way out of a situation that requires structural change, and lasting recovery requires building something different on the other side.',
    practicalExercise: {
      title: 'Root Cause vs. Symptom Analysis',
      steps: [
        { title: 'Track Symptom Response to Rest', description: 'When you take time off (weekend, vacation, sick day), note which symptoms get better and which do not. What improves: likely exhaustion, physical tension, irritability. What persists: likely cynicism, dread about returning, feelings of ineffectiveness.' },
        { title: 'Identify What Does NOT Improve', description: 'For symptoms that persist even with rest, ask: "What would have to change at work for this to get better?" Focus on environmental/structural answers, not "What do I need to do differently?" If cynicism and dread persist, rest is not the solution.' },
        { title: 'Choose One Structural Change', description: 'Based on your analysis, identify ONE concrete change to implement when you return from rest: a boundary (no email after 7pm), a workload adjustment (delegate one recurring task), a skill (practice saying no), or a relationship change (distance from toxic colleague).' },
        { title: '3-Month Assessment', description: 'Commit to the change for 3 months. Then assess: Are symptoms improving? Is this situation fixable with changes I can control, or do I need to leave? If rest plus change yields no improvement, the answer may be that the role itself is unsustainable.' },
      ],
      toolLink: '/tools/mood-journal',
      toolLabel: 'Track Recovery Patterns',
    },
    citations: [
      {
        id: '1',
      ...
      {
        id: '4',
        text: 'Burnout and depression comorbidity',
        source: 'Psychiatry Research',
        year: '2019',
        link: 'https://doi.org/10.1016/j.psychres.2019.02.062',
        tier: 1,
      },
      {
        id: '5',
        text: 'Work-life boundary management',
        source: 'Academy of Management Review',
        year: '2018',
        link: 'https://doi.org/10.5465/amr.2016.0330',
        tier: 1,
      },
      {
        id: '6',
        text: 'Role changes and burnout recovery',
        source: 'Journal of Applied Psychology',
        year: '2017',
        link: 'https://doi.org/10.1037/apl0000227',
        tier: 1,
      },
      {
        id: '7',
        text: 'Skill-building interventions for burnout',
        source: 'Clinical Psychology Review',
        year: '2019',
        link: 'https://doi.org/10.1016/j.cpr.2019.03.007',
        tier: 1,
      },
      {
        id: '8',
        text: 'Values-based interventions in workplace stress',
        source: 'Journal of Occupational Health Psychology',
        year: '2020',
        link: 'https://doi.org/10.1037/ocp0000189',
        tier: 1,
      },
    ],
    content: (
