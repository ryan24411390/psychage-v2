...
<div><div id="introduction" className="scroll-mt-32"><p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Your child wants to walk to their friend's house three blocks away. Your mind immediately floods with catastrophic scenarios—accidents, abduction, injury. You know these fears are disproportionate, but you say "It's not safe" anyway. Later, you notice your child hesitating before trying new things, asking "Is it safe?" before decisions, exhibiting the same hypervigilance you struggle with daily. This is the heartbreaking challenge of parenting with anxiety: the awareness that your internal battle might be shaping their emerging worldview.</p><p className="mb-6">Research confirms what many anxious parents fear: anxiety can be transmitted intergenerationally, not through genetics alone, but through parenting behaviors, emotional modeling, and family patterns <button type="button" id="citation-ref-1" className="
            ...
            "><div className="grid grid-cols-1 sm:grid-cols-3 divide-x divide-gray-100 dark:divide-neutral-800"><div className="flex flex-col items-center text-center p-6" style={{opacity:0,transform:'translateY(20px)'}}><div className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tabular-nums">2-3x</div><p className="mt-2 text-sm text-gray-500 dark:text-neutral-400 max-w-[200px]">Higher risk of anxiety disorders in children of anxious parents</p></div><div className="flex flex-col items-center text-center p-6" style={{opacity:0,transform:'translateY(20px)'}}><div className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tabular-nums">65%</div><p className="mt-2 text-sm text-gray-500 dark:text-neutral-400 max-w-[200px]">Reduction in child anxiety with parent-focused intervention</p></div><div className="flex flex-col items-center text-center p-6" style={{opacity:0,transform:'translateY(20px)'}}><div className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tabular-nums">40%</div><p className="mt-2 text-sm text-gray-500 dark:text-neutral-400 max-w-[200px]">Of childhood anxiety is influenced by parenting behavior (not just genetics)</p></div></div><div className="px-6 py-3 border-t border-gray-100 dark:border-neutral-800"><p className="text-xs text-gray-400 dark:text-neutral-500 italic text-center">Source: Journal of Child Psychology and Psychiatry, 2021; Clinical Psychology Review, 2020</p></div></div><div className="
                not-prose my-8 rounded-xl border-l-4 border-l-rose-400
                bg-rose-50 dark:bg-rose-950/20
                overflow-hidden

            " style={{opacity:0,transform:'translateY(16px)'}}><div className="flex items-start gap-3 p-5 "><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-stethoscope text-rose-500 mt-0.5 shrink-0"><path d="M4.8 2.3A.3.3 0 1 0 5 2H4a2 2 0 0 0-2 2v5a6 6 0 0 0 6 6a6 6 0 0 0 6-6V4a2 2 0 0 0-2-2h-1a.2.2 0 1 0 .3.3"></path><path d="M8 15v1a6 6 0 0 0 6 6a6 6 0 0 0 6-6v-4"></path><circle cx="20" cy="10" r="2"></circle></svg><div className="flex-1 min-w-0"><h4 className="font-bold text-sm text-rose-900 dark:text-rose-200">Clinical Note</h4><div className="mt-2 text-sm text-gray-700 dark:text-neutral-300 leading-relaxed [&>p]:mb-2 [&>p:last-child]:mb-0"><p>It's important to distinguish between appropriate caution and anxiety-driven overprotection. Teaching a 5-year-old to look both ways before crossing the street is appropriate. Not allowing a 10-year-old to walk to a friend's house two blocks away in a safe neighborhood because "something might happen" is anxiety-driven and limits healthy development of autonomy and confidence <button type="button" id="citation-ref-4" className="
                        inline-flex items-center justify-center
                        w-[18px] h-[18px] ml-0.5 -mt-2
                        text-[10px] font-bold text-teal-600 dark:text-teal-400
                        bg-teal-50 dark:bg-teal-900/30
...
<div><div id="introduction" className="scroll-mt-32"><p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Your partner reaches for you, and instead of connection, you feel a surge of anxiety. Your mind races: Do I look okay? Am I doing this right? What if I disappoint them? What if they're judging me? The moment that should be intimate becomes a performance evaluation. Or maybe it's emotional intimacy that triggers fear—your partner asks "What are you really feeling?" and you freeze, unable to access or articulate the vulnerability required. This is how anxiety infiltrates intimacy: turning connection into threat, closeness into exposure.</p><p className="mb-6">Anxiety and intimacy have a complicated relationship. Research shows that individuals with anxiety disorders report significantly lower relationship satisfaction, reduced emotional closeness, and higher rates of sexual dysfunction compared to those without anxiety <button type="button" id="citation-ref-1" className="
            ...
            "><div className="grid grid-cols-1 sm:grid-cols-3 divide-x divide-gray-100 dark:divide-neutral-800"><div className="flex flex-col items-center text-center p-6" style={{opacity:0,transform:'translateY(20px)'}}><div className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tabular-nums">40%</div><p className="mt-2 text-sm text-gray-500 dark:text-neutral-400 max-w-[200px]">of people with anxiety disorders report sexual difficulties</p></div><div className="flex flex-col items-center text-center p-6" style={{opacity:0,transform:'translateY(20px)'}}><div className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tabular-nums">30%</div><p className="mt-2 text-sm text-gray-500 dark:text-neutral-400 max-w-[200px]">Lower relationship satisfaction in anxious individuals</p></div><div className="flex flex-col items-center text-center p-6" style={{opacity:0,transform:'translateY(20px)'}}><div className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white tabular-nums">2.5x</div><p className="mt-2 text-sm text-gray-500 dark:text-neutral-400 max-w-[200px]">Higher risk of relationship dissolution with untreated anxiety</p></div></div><div className="px-6 py-3 border-t border-gray-100 dark:border-neutral-800"><p className="text-xs text-gray-400 dark:text-neutral-500 italic text-center">Source: Journal of Sex & Marital Therapy, 2020; Archives of Sexual Behavior, 2021</p></div></div><div className="
                not-prose my-8 rounded-xl border-l-4 border-l-rose-400
                bg-rose-50 dark:bg-rose-950/20
                overflow-hidden

            " style={{opacity:0,transform:'translateY(16px)'}}><div className="flex items-start gap-3 p-5 "><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-stethoscope text-rose-500 mt-0.5 shrink-0"><path d="M4.8 2.3A.3.3 0 1 0 5 2H4a2 2 0 0 0-2 2v5a6 6 0 0 0 6 6a6 6 0 0 0 6-6V4a2 2 0 0 0-2-2h-1a.2.2 0 1 0 .3.3"></path><path d="M8 15v1a6 6 0 0 0 6 6a6 6 0 0 0 6-6v-4"></path><circle cx="20" cy="10" r="2"></circle></svg><div className="flex-1 min-w-0"><h4 className="font-bold text-sm text-rose-900 dark:text-rose-200">Clinical Note</h4><div className="mt-2 text-sm text-gray-700 dark:text-neutral-300 leading-relaxed [&>p]:mb-2 [&>p:last-child]:mb-0"><p>Sexual difficulties related to anxiety are often bidirectional: anxiety causes sexual problems, and sexual problems increase anxiety. This creates a self-reinforcing cycle. Additionally, some medications used to treat anxiety (particularly SSRIs) can have sexual side effects, complicating the picture. If you're experiencing persistent sexual difficulties, discuss with both a mental health provider and a physician to address all contributing factors <button type="button" id="citation-ref-4" className="
                        inline-flex items-center justify-center
                        w-[18px] h-[18px] ml-0.5 -mt-2
                        text-[10px] font-bold text-teal-600 dark:text-teal-400
                        bg-teal-50 dark:bg-teal-900/30
