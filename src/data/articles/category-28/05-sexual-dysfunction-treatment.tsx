...
export const sexualDysfunctionTreatmentArticles: Article[] = [
  ...
  // --------------------------------------------------------------------------
  {
    ...
    practicalExercise: {
      ...
      steps: [
        { title: 'Understand responsive desire.', description: 'If you don\'t experience spontaneous sexual desire but find that desire emerges once you\'re engaged in sexual activity, this is a common pattern—not a dysfunction. Many women experience desire as responsive rather than spontaneous.' },
