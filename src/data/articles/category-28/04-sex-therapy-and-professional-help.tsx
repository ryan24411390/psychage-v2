  ...
  // --------------------------------------------------------------------------
  {
    ...
    content: (
      <>
        ...
        <p className="mb-6">In the GES framework, satisfying sex doesn't require perfect performance; 85% of sexual encounters involve some degree of imperfection (a lost erection, a moment of distraction, an orgasm that doesn't happen), and this is common. Sexual satisfaction comes from the overall quality of the couple's sexual life—not from any individual encounter's technical performance. Pleasure and connection are valued above performance metrics.</p>
