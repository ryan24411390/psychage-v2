...
export const sexualHealthEducationArticles: Article[] = [
  ...
  // --------------------------------------------------------------------------
  {
    ...
    content: (
      <>
        ...
        <p className="mb-6">Willoughby and Vitas (2012) identified desire discrepancy—the difference between partners in desired sexual frequency—as the most common sexual complaint in couples therapy, affecting the majority of couples at some point in their relationship. The challenge of desire discrepancy is not that it exists (some degree of discrepancy is common in virtually all couples) but how it is managed.</p>
  ...
  // --------------------------------------------------------------------------
  {
    ...
    practicalExercise: {
      ...
      steps: [
        { title: 'Reject ageist sexual myths.', description: 'Sexual desire, activity, and satisfaction are common at every age. If you are experiencing sexual changes, they are worth addressing—not accepting as inevitable decline.' },
