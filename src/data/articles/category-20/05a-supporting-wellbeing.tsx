  ...
  // --------------------------------------------------------------------------
  {
    ...
    practicalExercise: {
      ...
      steps: [
        ...
        { title: 'Identify your envelope', description: 'Look at the data and find your sustainable activity threshold --- the point at which you can function without triggering a crash the next day. This is your "energy envelope." It will be smaller than you expect, and that is common.' },
