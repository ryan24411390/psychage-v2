...
export const neurodevelopmentalArticles: Article[] = [
  { id: catId(41), slug: 'adhd-adults', status: 'published', title: "ADHD in Adults: The Condition That Wasn't Supposed to Exist Past Childhood", description: "ADHD persists into adulthood in 60% of cases. Learn about diagnosis and treatment in adults.", image: "/images/articles/cat13/cover-041.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 13, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['ADHD', 'Adult ADHD'], citations: [
  ...
  { id: catId(42), slug: 'adhd-women', status: 'published', title: "ADHD in Women and Girls: Why It's Underdiagnosed and Misunderstood", description: "ADHD presents differently in women, leading to underdiagnosis.", image: "/images/articles/cat13/cover-042.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 12, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["ADHD", 'Women', 'Gender'], citations: [
  ...
  { id: catId(44), slug: 'late-diagnosed-autism', status: 'published', title: 'Late-Diagnosed Autism: What Happens When You Find Out as an Adult', description: 'Adult autism diagnosis brings clarity and access to support.', image: "/images/articles/cat13/cover-044.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Autism", 'Late Diagnosis'], citations: [
  ...
  { id: catId(45), slug: 'adhd-autism-overlap', status: 'published', title: 'ADHD and Autism Overlap: When Conditions Co-Occur', description: 'ADHD and autism frequently co-occur, creating unique challenges.', image: "/images/articles/cat13/cover-045.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 9, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["ADHD", 'Autism', 'Comorbidity'], citations: [
...
export const eatingDisordersArticles: Article[] = [
  { id: catId(51), slug: 'anorexia-nervosa', status: 'published', title: 'Anorexia Nervosa: More Than Just Not Eating', description: 'AN involves restriction, fear of weight gain, body image distortion.', image: "/images/articles/cat13/cover-051.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Anorexia", 'Eating Disorders'],
...
export const psychoticPersonalityArticles: Article[] = [
  ...
  { id: catId(72), slug: 'schizoaffective-disorder', status: 'published', title: 'Schizoaffective Disorder: When Psychosis Meets Mood Episodes', description: 'Schizoaffective disorder combines schizophrenia and mood disorder features.', image: "/images/articles/cat13/cover-072.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Schizoaffective', 'Psychosis'],
  ...
  { id: catId(80), slug: 'living-with-personality-disorder', status: 'published', title: 'Living with a Personality Disorder: Recovery, Support, and Hope', description: 'Personality disorders are treatable. Learn about recovery journeys and available support.', image: "/images/articles/cat13/cover-080.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 8, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Personality Disorders', 'Recovery'],
