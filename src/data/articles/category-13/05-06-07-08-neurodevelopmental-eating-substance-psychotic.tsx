...
export const neurodevelopmentalArticles: Article[] = [
  { id: catId(41), slug: 'adhd-adults', status: 'draft', title: "ADHD in Adults: The Condition That Wasn't Supposed to Exist Past Childhood", description: "ADHD persists into adulthood in 60% of cases. Learn about diagnosis and treatment in adults.", image: "/images/articles/cat13/cover-041.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 13, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['ADHD', 'Adult ADHD'], citations: [
  ...
  { id: catId(43), slug: 'autism-adults', status: 'draft', title: 'Autism Spectrum: Understanding Neurodiversity in Adults', description: 'Autism is lifelong. Learn about adult diagnosis and support.', image: "/images/articles/cat13/cover-043.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 13, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Autism", 'ASD', 'Neurodiversity'], citations: [
    ...
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Autism isn't "curable" nor does it need to be. Support focuses on accommodations that allow autistic individuals to thrive: workplace modifications (quiet spaces, clear communication, flexibility with social events), sensory-friendly environments, and acceptance of autistic communication styles. Therapy addresses co-occurring conditions (anxiety, depression) rather than trying to make autistic people "act normal." The neurodiversity movement advocates for acceptance and accommodation rather than normalization, emphasizing that autistic people bring valuable perspectives and should have agency in their own support decisions.</p>
  </> },
  { id: catId(44), slug: 'late-diagnosed-autism', status: 'draft', title: 'Late-Diagnosed Autism: What Happens When You Find Out as an Adult', description: 'Adult autism diagnosis brings clarity and access to support.', image: "/images/articles/cat13/cover-044.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Autism", 'Late Diagnosis'], citations: [
    ...
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Adult autism assessment typically involves detailed developmental history (often requiring childhood records or parent interviews), clinical interview, self-report questionnaires, and sometimes standardized assessments like ADOS-2. Challenges arise because many adults have developed sophisticated masking strategies that conceal autistic traits during brief clinical encounters. Women and non-binary individuals face particular diagnostic barriers due to gender biases in assessment tools developed primarily studying autistic boys <Citation id="3" index={3} source="JADD" year="2020" tier={1} />. Diagnosis opens access to support services, workplace accommodations, and community connection.</p>
  ...
  { id: catId(45), slug: 'adhd-autism-overlap', status: 'draft', title: 'ADHD and Autism Overlap: When Conditions Co-Occur', description: 'ADHD and autism frequently co-occur, creating unique challenges.', image: "/images/articles/cat13/cover-045.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 9, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["ADHD", 'Autism', 'Comorbidity'], citations: [
    ...
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Treatment requires addressing both conditions. ADHD medication can help with focus and impulsivity but won't address autistic communication or sensory needs. Therapy should integrate strategies: environmental structure (autism) + external scaffolding for executive function (ADHD), social skills training adapted for both conditions, sensory accommodations <Citation id="3" index={3} source="Journal of Attention Disorders" year="2020" tier={1} />. Self-compassion is crucial--dual diagnosis isn't "twice the deficit" but different wiring requiring individualized support.</p>
  </> },
  { id: catId(46), slug: 'hyperkinetic-disorder', status: 'draft', title: 'Hyperkinetic Disorder: Understanding the ICD Perspective on Attention and Activity', description: 'Hyperkinetic disorder is the ICD equivalent of ADHD.', image: "/images/articles/cat13/cover-046.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Hyperkinetic Disorder", 'ADHD', 'ICD'], citations: [
  ...
  { id: catId(49), slug: 'neurodevelopmental-mental-health', status: 'draft', title: 'Neurodevelopmental Conditions and Mental Health: The Comorbidity Challenge', description: 'ADHD and autism increase risk for anxiety, depression, and other conditions.', image: "/images/articles/cat13/cover-049.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 9, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Neurodevelopmental", 'Comorbidity'], citations: [
    ...
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Comorbidity complicates treatment but doesn't make it impossible. Comprehensive assessment identifying all conditions is crucial. Often treating the neurodevelopmental condition (ADHD medication, autism accommodations) reduces secondary mental health symptoms. Some conditions require specific treatment: anxiety may need CBT or medication beyond ADHD treatment, depression may need antidepressants. Integrated care addressing all conditions simultaneously produces best outcomes rather than treating each separately.</p>
  </> },
  { id: catId(50), slug: 'support-accommodation', status: 'draft', title: 'Support and Accommodation: Building a Life That Works with Your Brain', description: 'Accommodations improve functioning for neurodivergent individuals.', image: "/images/articles/cat13/cover-050.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Accommodations", 'Support', 'Neurodiversity'], citations: [
    ...
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Workplace: modified schedules, quiet spaces, clear written communication, reduced social requirements (optional company events), permission to stim/fidget, task prioritization support. Educational: extended test time, note-taking assistance, reduced sensory input (alternative testing locations), breaks during long classes. Daily life: online grocery delivery, meal prep services, hiring help for overwhelming tasks, structuring routines, using technology (apps, reminders, timers). Social: communicating your needs directly ("I prefer texting to phone calls"), selective socializing, bringing fidgets to events, leaving when overwhelmed.</p>
...
export const eatingDisordersArticles: Article[] = [
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Emily spent three hours at the grocery store, scrutinizing every label for artificial ingredients, pesticides, or "toxins." She ate only raw, organic vegetables and sprouted grains--nothing processed, heated above 118°F, or grown with conventional farming. Friends stopped inviting her to dinner. Restaurants were off-limits. Her hair was falling out from malnutrition. But Emily felt virtuous: she was "eating clean."</p>
  ...
  { id: catId(57), slug: 'eating-disorders-athletes', status: 'draft', title: 'Eating Disorders and Athletes: Performance Pressure and Body Control', description: 'Athletes face heightened ED risk in weight-sensitive sports.', image: "/images/articles/cat13/cover-057.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 9, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ["Athletes", 'Eating Disorders'], summary: 'Athletes face significantly elevated eating disorder risk, especially in sports emphasizing leanness, weight requirements, or aesthetic judgment. What begins as performance optimization can escalate into life-threatening illness when insufficient energy intake causes Relative Energy Deficiency in Sport (RED-S), compromising health, performance, and long-term well-being.', keyFacts: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Sarah was the fastest runner on her high school cross-country team. When her coach suggested that "losing a few pounds" might shave seconds off her times, she took it seriously. She cut portions, then entire meals, then food groups. Her times initially improved--until they didn't. Stress fractures sidelined her. Her periods stopped. She was cold all the time, exhausted, injured constantly. But she couldn't stop--because everyone praised her "dedication."</p>
...
export const substanceSleepSomaticArticles: Article[] = [
  ...
  { id: catId(62), slug: 'substance-use-disorder', status: 'draft', title: 'Substance Use Disorder: Understanding Addiction Beyond Willpower', description: 'SUD is a chronic brain disease, not a moral failing. Learn about causes and treatment.', image: "/images/articles/cat13/cover-062.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Addiction', 'Substance Use'], summary: 'Substance Use Disorder (SUD) is a chronic brain disease involving compulsive substance seeking despite devastating consequences. Affecting millions across all demographics, SUD fundamentally rewires brain reward circuits--making recovery require professional treatment, not willpower alone. Evidence-based medications and behavioral therapies produce sustained recovery for the majority who access them.', keyFacts: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">James started taking oxycodone after back surgery. When the prescription ran out, the pain had mostly healed--but the cravings hadn't. Within six months, he was buying pills on the street. Within a year, he'd lost his job, his savings, and nearly his life to an overdose. "I thought I was stronger than this," he said. "I kept thinking I could stop whenever I wanted. But my brain had other plans."</p>
  ...
  { id: catId(63), slug: 'self-medication-hypothesis', status: 'draft', title: 'The Self-Medication Hypothesis: Why People Use Substances to Cope', description: 'Many with mental illness use substances to manage symptoms. Understand this dangerous pattern.', image: "/images/articles/cat13/cover-063.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 9, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Substance Use', 'Comorbidity', 'Self-Medication'], summary: 'The self-medication hypothesis explains why many people with mental health conditions turn to substances--they temporarily relieve unbearable symptoms. While this provides short-term relief, it creates a vicious cycle where substances worsen the underlying condition and create dependence. Integrated treatment addressing both conditions simultaneously offers the path forward.', keyFacts: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Maria's panic attacks were destroying her life. Medication hadn't helped, therapy felt too slow, and she couldn't afford to miss more work. Then someone offered her a Xanax at a party. For the first time in months, she could breathe. Within a year, she was buying benzodiazepines illegally, her panic disorder was worse than ever, and she'd developed a substance use disorder on top of her anxiety. "I wasn't trying to get high," she explained. "I was just trying to function."</p>
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Imagine being in the middle of a conversation, laughing with friends, when suddenly your knees buckle and you collapse to the floor--fully conscious but unable to move. Or sitting in an important meeting, fighting an overwhelming wave of sleepiness so intense that no amount of willpower can keep your eyes open. This is the daily reality for people living with narcolepsy, a chronic neurological disorder that disrupts the brain's fundamental ability to control when we sleep and when we wake.</p>
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">You wake with a slight chest twinge. Within seconds: "Is this a heart attack? Should I go to the ER?" You Google "chest pain left side" and spend the next hour convinced you have a life-threatening condition, despite being 28 with no risk factors. Your doctor says it's muscle strain. You feel relief--for about a day. Then a new symptom appears, and the cycle begins again.</p>
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">"Just stop using." If addiction recovery were that simple, we wouldn't have an overdose crisis killing over 100,000 Americans annually. Harm reduction offers a different approach: What if, instead of demanding people stop using drugs before we help them, we focused on keeping them alive and reducing suffering--regardless of whether they're ready to quit?</p>
...
export const psychoticPersonalityArticles: Article[] = [
      ...
      tabs={[
        {
          ...
          content: <div className="p-4">
            <p className="mb-4 text-gray-700 dark:text-neutral-300"><strong>Positive symptoms</strong> are experiences added to normal functioning:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700 dark:text-neutral-300">
        ...
        },
        {
          ...
          content: <div className="p-4">
            <p className="mb-4 text-gray-700 dark:text-neutral-300"><strong>Negative symptoms</strong> represent reductions in normal functioning:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700 dark:text-neutral-300">
            ...
            <p className="text-gray-700 dark:text-neutral-300">Negative symptoms are often more debilitating long-term than positive symptoms and are harder to treat.</p>
          </div>
        },
        {
          label: 'Cognitive Symptoms',
          content: <div className="p-4">
            <p className="mb-4 text-gray-700 dark:text-neutral-300"><strong>Cognitive symptoms</strong> affect thinking abilities:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700 dark:text-neutral-300">
            ...
            <p className="text-gray-700 dark:text-neutral-300">These cognitive impairments significantly impact work performance, independent living, and social relationships <Citation id="8" index={4} source="Biological Psychiatry" year="2021" tier={1} />.</p>
          </div>
        },
      ]}
    />
  ...
  { id: catId(72), slug: 'schizoaffective-disorder', status: 'draft', title: 'Schizoaffective Disorder: When Psychosis Meets Mood Episodes', description: 'Schizoaffective disorder combines schizophrenia and mood disorder features.', image: "/images/articles/cat13/cover-072.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Schizoaffective', 'Psychosis'],
    ...
    content: <>
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Imagine experiencing hallucinations and delusions like schizophrenia, but also cycling through severe depression or mania like bipolar disorder--sometimes separately, sometimes simultaneously. This is the reality of schizoaffective disorder, a condition that sits at the intersection of psychotic and mood disorders. Affecting approximately 0.3% of the population, schizoaffective disorder is less common than either schizophrenia or bipolar disorder alone <Citation id="1" index={1} source="AJP" year="2021" tier={1} />, yet it's frequently misdiagnosed as one of those conditions due to overlapping symptoms.</p>
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Imagine feeling terror at the thought of making a simple decision without someone else's approval. Imagine staying in a relationship where you're mistreated because the alternative--being alone--feels like certain death. For people living with dependent personality disorder, these aren't hypothetical scenarios. They're daily realities.</p>
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Most people assume that anyone who spends extensive time alone must be lonely, anxious, or socially impaired. For people with schizoid personality disorder, this assumption misses the mark entirely. They're not avoiding social connection because it's frightening or difficult. They simply don't want it.</p>
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Life throws curveballs. Most people weather them with typical stress responses--temporary distress that resolves as they adapt. But sometimes a stressor overwhelms coping capacity, producing symptoms that significantly impair functioning. When this happens without meeting criteria for a more specific disorder, the diagnosis may be adjustment disorder.</p>
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Everyone has a personality--a characteristic way of thinking, feeling, and behaving. But what happens when these patterns become so rigid and maladaptive that they cause significant distress or interfere with every area of life? That's when we enter personality disorder territory.</p>
  ...
  { id: catId(80), slug: 'living-with-personality-disorder', status: 'draft', title: 'Living with a Personality Disorder: Recovery, Support, and Hope', description: 'Personality disorders are treatable. Learn about recovery journeys and available support.', image: "/images/articles/cat13/cover-080.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 8, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Personality Disorders', 'Recovery'],
  ...
  citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">If you've been diagnosed with a personality disorder, you've likely heard that it's untreatable, that you're manipulative, that you have a "character flaw" rather than a mental health condition. You may have been told you'll never get better. These messages are not just wrong--they're harmful lies that prevent people from seeking the help that works.</p>
