...
export const traumaDissociativeArticles: Article[] = [
  ...
  { id: catId(23), slug: 'acute-stress-disorder', status: 'published', title: 'Acute Stress Disorder: The Immediate Aftermath of Trauma', description: 'ASD occurs within days to weeks after trauma. Early intervention prevents PTSD development.', image: "/images/articles/cat13/cover-023.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 11, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['ASD', 'Acute Stress', 'Trauma'], citations: [
  ...
  { id: catId(25), slug: 'osdd', status: 'published', title: 'Other Specified Dissociative Disorder: The In-Between Diagnosis', description: 'OSDD captures dissociative experiences not meeting full DID criteria.', image: "/images/articles/cat13/cover-025.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 10, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['OSDD', 'Dissociation'], citations: [
  ...
  { id: catId(26), slug: 'depersonalization-derealization', status: 'published', title: 'Depersonalization and Derealization: When Reality Feels Unreal', description: 'DPDR involves feeling detached from self or surroundings. Learn causes and treatments.', image: "/images/articles/cat13/cover-026.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 12, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Depersonalization', 'Derealization', 'Dissociation'], citations: [
  ...
  { id: catId(29), slug: 'trauma-substance-use', status: 'published', title: 'The Relationship Between Trauma Disorders and Substance Use', description: 'Trauma and addiction commonly co-occur. Understand the self-medication hypothesis and integrated treatment.', image: "/images/articles/cat13/cover-029.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 8, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Trauma', 'Substance Use', 'Dual Diagnosis'], citations: [
