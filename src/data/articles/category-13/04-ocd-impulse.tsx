...
export const ocdImpulseArticles: Article[] = [
  { id: catId(31), slug: 'ocd-explained', status: 'published', title: 'OCD Explained: Beyond Handwashing and Checking --- The Full Picture', description: 'OCD is intrusive obsessions + compulsions. Understand the condition beyond stereotypes.', image: "/images/articles/cat13/cover-031.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 14, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['OCD', 'Obsessions', 'Compulsions'], citations: [
    ...
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Exposure and Response Prevention: Gradual exposure to feared stimuli while preventing compulsions. Shows 60-70% symptom reduction <Citation id="3" index={3} source="Lancet Psychiatry" year="2020" tier={1} />. SSRIs (fluoxetine, sertraline) at higher doses than depression help 40-60% <Citation id="5" index={4} source="JAMA Psychiatry" year="2020" tier={1} />. Combination therapy most effective.</p>
  ...
  { id: catId(33), slug: 'body-dysmorphic-disorder', status: 'published', title: "Body Dysmorphic Disorder: When You Can't Stop Seeing Flaws", description: "BDD involves preoccupation with perceived appearance defects. Understand this OCD-related condition.", image: "/images/articles/cat13/cover-033.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 13, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['BDD', 'Body Image', 'OCD Spectrum'], citations: [
  ...
  { id: catId(35), slug: 'excoriation-disorder', status: 'published', title: 'Excoriation Disorder: When Skin-Picking Becomes Compulsive', description: 'SPD is recurrent skin-picking causing distress and damage.', image: "/images/articles/cat13/cover-035.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 11, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Skin Picking', 'Excoriation', 'OCD Spectrum'], citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Excoriation (skin-picking) disorder involves recurrent picking at one's skin resulting in lesions, despite repeated attempts to stop <Citation id="1" index={1} source="DSM-5-TR" year="2022" tier={4} />. Picking provides temporary relief but causes tissue damage, scarring, infections. Prevalence 1-2%, predominantly female <Citation id="3" index={2} source="Journal of Psychiatric Research" year="2020" tier={1} />.</p>
    </div>
    <h2 id="treatment" className="text-3xl font-display font-bold text-gray-900 dark:text-white mt-12 mb-6 scroll-mt-32">Treatment</h2>
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Habit Reversal Training teaches awareness, competing response (fidget tools, stress balls), stimulus control (covering mirrors, wearing gloves, keeping nails trimmed) <Citation id="2" index={3} source="Behavior Therapy" year="2021" tier={1} />. Address underlying anxiety/stress. SSRIs may help reduce urges.</p>
  ...
  { id: catId(36), slug: 'intermittent-explosive-disorder', status: 'published', title: 'Intermittent Explosive Disorder: Understanding Disproportionate Anger Outbursts', description: 'IED involves impulsive aggression out of proportion to triggers.', image: "/images/articles/cat13/cover-036.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 12, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['IED', 'Anger', 'Impulse Control'], citations: [
    ...
    <div id="introduction" className="scroll-mt-32">
      <p className="lead text-xl text-gray-600 dark:text-neutral-300 mb-8 leading-relaxed">Intermittent Explosive Disorder involves recurrent behavioral outbursts representing failure to control aggressive impulses, grossly out of proportion to provocation <Citation id="1" index={1} source="DSM-5-TR" year="2022" tier={4} />. Outbursts: verbal aggression (tantrums, arguments) or physical aggression toward property/animals/people. Person feels tension before, relief after, then guilt/regret. Prevalence 3-5% <Citation id="2" index={2} source="JAMA Psychiatry" year="2020" tier={1} />.</p>
    </div>
    <h2 id="treatment" className="text-3xl font-display font-bold text-gray-900 dark:text-white mt-12 mb-6 scroll-mt-32">Treatment</h2>
    <p className="mb-6 text-lg text-gray-700 dark:text-neutral-300">Cognitive-behavioral therapy with anger management, relaxation training, cognitive restructuring shows 50-60% reduction in outbursts <Citation id="3" index={3} source="Behavior Therapy" year="2021" tier={1} />. Medications (mood stabilizers, SSRIs) may help reduce irritability.</p>
  ...
  { id: catId(38), slug: 'ocd-spectrum', status: 'published', title: 'The OCD Spectrum: How Related Conditions Share Common Ground', description: 'OCD-related disorders share repetitive behaviors and intrusive thoughts.', image: "/images/articles/cat13/cover-038.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 8, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['OCD Spectrum', 'Related Disorders'], citations: [
  ...
  { id: catId(40), slug: 'erp-treatment', status: 'published', title: 'ERP and Other Treatments for OCD Spectrum Conditions', description: 'Exposure and Response Prevention is the gold-standard treatment for OCD.', image: "/images/articles/cat13/cover-040.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 9, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['ERP', 'OCD Treatment', 'Therapy'],
