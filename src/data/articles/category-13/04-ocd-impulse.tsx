...
export const ocdImpulseArticles: Article[] = [
  ...
  { id: catId(33), slug: 'body-dysmorphic-disorder', status: 'draft', title: "Body Dysmorphic Disorder: When You Can't Stop Seeing Flaws", description: "BDD involves preoccupation with perceived appearance defects. Understand this OCD-related condition.", image: "/images/articles/cat13/cover-033.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 13, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['BDD', 'Body Image', 'OCD Spectrum'], citations: [
  ...
  { id: catId(35), slug: 'excoriation-disorder', status: 'draft', title: 'Excoriation Disorder: When Skin-Picking Becomes Compulsive', description: 'SPD is recurrent skin-picking causing distress and damage.', image: "/images/articles/cat13/cover-035.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 11, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['Skin Picking', 'Excoriation', 'OCD Spectrum'], citations: [
  ...
  { id: catId(36), slug: 'intermittent-explosive-disorder', status: 'draft', title: 'Intermittent Explosive Disorder: Understanding Disproportionate Anger Outbursts', description: 'IED involves impulsive aggression out of proportion to triggers.', image: "/images/articles/cat13/cover-036.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 12, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['IED', 'Anger', 'Impulse Control'], citations: [
  ...
  { id: catId(38), slug: 'ocd-spectrum', status: 'draft', title: 'The OCD Spectrum: How Related Conditions Share Common Ground', description: 'OCD-related disorders share repetitive behaviors and intrusive thoughts.', image: "/images/articles/cat13/cover-038.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 8, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['OCD Spectrum', 'Related Disorders'], citations: [
  ...
  { id: catId(40), slug: 'erp-treatment', status: 'draft', title: 'ERP and Other Treatments for OCD Spectrum Conditions', description: 'Exposure and Response Prevention is the gold-standard treatment for OCD.', image: "/images/articles/cat13/cover-040.svg", category: CATEGORY_MENTAL_HEALTH_CONDITIONS, readTime: 9, publishedAt: '2026-03-17', author: PRIMARY_AUTHOR, reviewedBy: CLINICAL_REVIEWER, tags: ['ERP', 'OCD Treatment', 'Therapy'],
