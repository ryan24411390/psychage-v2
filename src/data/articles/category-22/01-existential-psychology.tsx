  ...
  // --------------------------------------------------------------------------
  {
    ...
    content: (
      <>
        ...
        <p className="mb-6">
          A crucial distinction: existential anxiety isn't pathological. It doesn't indicate a broken brain
      ...
      <>
        <div id="introduction" className="scroll-mt-32">
          ...
          <p className="mb-6">
            ...
            is life worth living? His answer — yes, emphatically, defiantly yes — is the foundation of
