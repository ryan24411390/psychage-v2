...
export const selfCompassionArticlesB: Article[] = [
  {
    ...
    content: (
      <>
        ...
        <ComparisonTable title="Helpful vs. Harmful Self-Talk Examples" columns={['Situation', 'Harmful Self-Talk', 'Helpful Self-Talk']} items={[{ feature: 'Made a mistake at work', values: ["I'm so stupid, I always mess up", 'I made a mistake --- what can I learn from it?'] }, { feature: 'Facing a difficult challenge', values: ["This is too hard, I can't do it", 'This is tough, but I can try my best and ask for help'] }, { feature: 'Feeling anxious before an event', values: ['Something terrible is going to happen', "I feel anxious, and that's a common response. I can manage this."] }, { feature: 'Received critical feedback', values: ["I'm worthless, everyone thinks I'm incompetent", "That feedback was hard to hear --- let me separate what's useful from what's unfair"] }]} highlightColumn={2} />
        <p className="mb-6">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p className="mb-6">
          Almost everyone encounters obstacles when first practicing the Self-Compassion Break. These challenges do not mean the practice is failing --- they are common parts of learning a new skill, especially one that involves treating yourself differently than you are accustomed to.
        </p>
        <BeforeAfter
          before={{
            title: 'Challenge',
          ...
          after={{
            title: 'Solution',
            points: [
              'Common at first --- the action matters more than the feeling. Behavior change precedes belief change.',
        ...
        <ArticleCallout variant="key-takeaway" title="Key Takeaways">
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>Feeling awkward or inauthentic at first is common and expected --- behavior change precedes belief change</li>
