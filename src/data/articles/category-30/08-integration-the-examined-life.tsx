  ...
  // --------------------------------------------------------------------------
  {
    ...
    content: (
      <>
        ...
        <h3 id="ordinary-magic-resilience-is-normal" className="text-2xl font-display font-semibold text-gray-900 dark:text-white mt-10 mb-4 scroll-mt-32">Ordinary Magic: Resilience Is Common</h3>
  ...
  // --------------------------------------------------------------------------
  {
    ...
    practicalExercise: {
      ...
      steps: [
        ...
        { title: 'Use the Psychage tools.', description: 'The **Mood Journal** for emotional tracking, the **Sleep Architect** for sleep optimization, the **Clarity Score** for cognitive assessment, the **Symptom Navigator** for understanding your experiences, the **Provider Directory** for professional support, and **Psychage AI** for compassionate conversation — each is designed to support one dimension of your toolkit.' },
