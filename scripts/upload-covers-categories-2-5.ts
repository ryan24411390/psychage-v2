 ...
 *
 * Usage:
 *   npx tsx scripts/upload-covers-categories-2-5.ts              # Dry-run (default)
 *   npx tsx scripts/upload-covers-categories-2-5.ts --execute     # Upload + rename
 *   npx tsx scripts/upload-covers-categories-2-5.ts --category 3  # Single category
 *   npx tsx scripts/upload-covers-categories-2-5.ts --execute --category 2
 */
...
const CATEGORIES: CategoryConfig[] = [
  {
    ...
    prefix: 'ANX',
    catId: 'CAT02',
    imageDir: '/Users/raiyanabdullah/Downloads/Psychage Category 2',
  },
  {
    categoryNumber: 3,
    prefix: 'REL',
    catId: 'CAT03',
    imageDir: '/Users/raiyanabdullah/Downloads/Psychage category 3',
  },
  {
    categoryNumber: 4,
    prefix: 'SLF',
    catId: 'CAT04',
    imageDir: '/Users/raiyanabdullah/Downloads/Psychage poster category 4',
  },
  {
    categoryNumber: 5,
    prefix: 'WRK',
...
async function processCategory(
  ...
  // 5. Find DB articles without images
...
function printReport(report: CategoryReport): void {
  ...
  if (articlesWithoutImages.length > 0) {
    console.log(`  DB ARTICLES WITHOUT IMAGES:`);
    console.log(`  ${'-'.repeat(86)}`);
